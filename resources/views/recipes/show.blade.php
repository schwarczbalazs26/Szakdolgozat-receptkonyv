    ...
    <div class="flex justify-center bg-gray-100 dark:bg-gray-800">
        <div class="flex flex-col md:flex-row mt-8 p-8 border border-gray-300 rounded-lg bg-gray-100 dark:bg-gray-800 text-white"
            ...
            <div class="w-full md:w-2/3">
                <h1 class="text-3xl font-bold mb-4 text-center text-gray-800 dark:text-gray-200">{{ strtoupper($recipe->title) }}</h1>

                <div class="mb-6">
                    <img src="{{ asset('storage/' . $recipe->filename) }}" alt="{{ $recipe->title }}"
                        class="w-full max-w-full h-auto mb-4" style="width: 600px; height: 400px;">

                    <div class="border-t border-b border-gray-300 rounded-lg p-4 recipe-details text-white dark:text-gray-200 dark:bg-gray-800 bg-gray-500">
            ...
            <div class="w-full md:w-1/3 mt-8 md:mt-0 md:ml-8">
                <div class="max-w-sm p-8 border border-gray-300 rounded-lg bg-gray-500 dark:bg-gray-800 text-white dark:text-gray-200 allergens-container">
                    <h2 class="text-2xl font-bold mb-4 text-center text-gray-800 dark:text-gray-200 bg-gray-500 dark:bg-gray-800">ALLERGENS</h2>
